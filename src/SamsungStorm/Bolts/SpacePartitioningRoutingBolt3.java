 ...
 */
public class SpacePartitioningRoutingBolt3 extends BaseBasicBolt {
...
//    OutputCollector collector;
    ...
    public SpacePartitioningRoutingBolt3(int gridSize, int cluster) {
